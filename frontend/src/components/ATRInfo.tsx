...
export default function ATRInfo({ currentAtr, volatilityAmount, multiplier, currency }: ATRInfoProps) {
    ...
    return (
        <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl mt-6 flex flex-wrap gap-3 sm:gap-6 items-center w-full max-w-6xl mx-auto">
            <div>
